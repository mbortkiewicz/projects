...
public class TTitle_book {
	...
	/*
	 * public TBook search_title(TTitle_book title_book){ String title; String
	 * book_info[]=new String[3]; TBook book; if((title==title_book.title)){
	 * book_info={"tytu³: " +title_book.title,"autor:"+title_book.author,
	 * "ISBN: "+title_book.ISBN}; System.out.println(book_info); //1-a iteracja
	...
	/*
	 * public String[] toString_() { throw new
	 * UnsupportedOperationException("Not supported yet."); } //kolejne iteracje
	 * public String search_accessible_book(Object data) { throw new
	 * UnsupportedOperationException("Not supported yet."); } public String
	 * getActor() { throw new
